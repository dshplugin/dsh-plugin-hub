...
**DeepSeek Harness 社区插件市场：收录 4,805 个 DSH plugin，人工精选验证 4,401**
...
<p align="center">
  <img src="docs/screenshots/dsh-plugin-hub-home-zh.png" alt="DSH-Plugin Hub in DeepSeek Harness" width="840">
</p>
...
- 收录 **4,805** 个社区插件，其中 **4,401** 已人工精选验证，由 [dsh-plugin.org](https://dsh-plugin.org) 每日收录、人工审核并发布
...
| 一键安装 | 一键卸载 |
| :---: | :---: |
| <img src="docs/screenshots/dsh-plugin-hub-install-zh.png" alt="一键安装" width="400" height="280"> | <img src="docs/screenshots/dsh-plugin-hub-uninstall-zh.png" alt="一键卸载" width="400" height="280"> |
| 后台队列串行执行，弹窗实时显示安装进度，可随时取消 | 卸载全程可视化，实时进度一目了然，成功即生效 |

| 一键更新 | 通知中心 |
| :---: | :---: |
| <img src="docs/screenshots/dsh-plugin-hub-update-zh.png" alt="一键更新" width="400" height="280"> | <img src="docs/screenshots/dsh-plugin-hub-notifications-zh.png" alt="可视化消息通知" width="400" height="280"> |
...
DSH-Plugin 插件中心收录 **4,805** 个 DeepSeek Harness Plugin（DSH）插件，其中 **4,401** 已人工精选验证，每日更新，免费按分类浏览、搜索、下载与安装，来源可溯。
