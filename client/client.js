window.__ModuleLoader__.load({ id: "dsh-plugin", factory: (require) => {
		...
		var Section_module_css_default = {
			...
			"list": "XlLbKa_list",
			"progressTrack": "XlLbKa_progressTrack",
			...
			"progressFill": "XlLbKa_progressFill",
			...
			"progressHead": "XlLbKa_progressHead",
			...
			"progressFillFail": "XlLbKa_progressFillFail",
			...
			"progressText": "XlLbKa_progressText",
		...
		*/
		...
		function PluginHubSection({ t: _hostT, locale }) {
			...
			})), task.lines.length > 0 ? (0, react.createElement)("pre", { className: Section_module_css_default.progressLog }, task.lines.slice(0, 6).reverse().join("\n")) : null) : null;
