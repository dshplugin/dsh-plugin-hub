...
import { probeUrl, systemProxy } from '../services/probe.js';
import { activeTask, cancelTask, dumpLoaderEntries, getTask, githubRepoOf, githubTarget, hasQueuedTarget, installTargetOf, listPendingRestarts, readProfileArg, startPluginMutation, validPackageName } from '../services/install/install.js';
...
import { appendLog, readLog, logFilePath, defaultLogFilePath, customLogFile } from '../services/log.js';
    ...
    const disposers = [
        ...
        webServer.register({
            ...
            handler: async (request, response) => {
                ...
                try {
                    ...
                    for (const key of ['checkUpdatesOnStart', 'autoInstallUpdates', 'enableNpmInstall', 'enableGitInstall', 'npmRegistry', 'proxy', 'logPath']) {
        ...
        webServer.register({
            ...
            handler: async (request, response) => {
                ...
                const probe = (url) => probeUrl(url, effectiveProxy, 6000);
